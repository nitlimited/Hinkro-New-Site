...
const NAV: Record<string, NavEntry[]> = {
  admin: [
    ...
    { to: "/portal/admin/accessories", label: "Accessories", icon: <Package size={18} /> },
  ...
  content: [
    ...
    { to: "/portal/content/accessories", label: "Accessories", icon: <Package size={18} /> },
    { to: "/portal/content/blog", label: "Blog", icon: <FileText size={18} /> },
    { to: "/portal/content/media", label: "Media library", icon: <Image size={18} /> },
    { to: "/portal/content/categories", label: "Categories", icon: <ListTree size={18} /> },
  ],
  weaver: [
