...
export const demoWeaverProfiles: WeaverProfileRow[] = [
  {
    ...
    loom_count: 2,
    occupied_looms: 2,
    avg_weaving_hours_per_day: 8,
    avg_days_per_cloth: 14,
    queue_length: 1,
    unavailable_until: daysAhead(12),
    availability_note: "Loom 1 is on HK-2026-0041; Loom 2 is reserved for a personal customer project.",
  ...
  },
  {
    ...
    loom_count: 3,
    occupied_looms: 1,
    avg_weaving_hours_per_day: 6,
    avg_days_per_cloth: 18,
    queue_length: 0,
    unavailable_until: null,
    availability_note: "Available for one new Hinkro project this week.",
